...
import { Game, Players, Inventory, LeaderBoard, BuildBlocksSet, Teams, Damage, BreackGraph, Ui, Properties, GameMode, Spawns, Timers, AreaPlayerTriggerService, AreaViewService } from 'pixel_combats/room';
...
var UnCapturedColor = new Color(1, 1, 1, 1);
...
function CapturePropOnValue(prop) {
	...
	// Отмечаем, зону захваченой/незахваченой
...
// Задаём или снимаем, спавнпоинты захваченной, области
...
// Делаем моментальный, спавн синим/красным
...
function SetWaitingMode() {
	...
	Ui.GetContext().Hint.Value = "ОЖИДАНИИЕ, ИГРОКОВ...";
